...
"""
Author: Nick Russo
Purpose: Convert network configuration using zero-shot prompting.
"""
...
def main(args):
    ...
    # Open the platform map, prompt template, and source config
    in_dir = "gai/inputs"
    ...
    question = prompt.format(
        src_type=args.src_os,
        dst_type=args.dst_os,
